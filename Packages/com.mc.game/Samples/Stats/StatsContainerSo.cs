...
{
    [Serializable]
    public class StatEntryData : IStatEntryDefinition
    {
        ...
        public IStatSourceDefinition Source => Stat.Source;
    }
    ...
    public class StatsContainerSo : ScriptableObject, IStatContainerDefinition
    {
        [SerializeField] private List<StatEntryData> _stats = new();

        public IReadOnlyList<IStatEntryDefinition> Stats => _stats;

        public bool TryGetStatValue(StatDefinitionSo stat, out float value)
        {
            if (stat != null)
            {
